package com.wooliesx.test.utils;
...
public class AppUtils {
	...
	private boolean remote_execution;
	@Value("${appium.host}")
	...
	@Bean(destroyMethod = "quit", name = "apputils")
	@Scope("cucumber-glue")
	public AppiumDriver<? extends MobileElement> getDriver() throws MalformedURLException {
		...
		if (remote_execution == false)
			serverUrl = new URL("http://localhost:" + appiumPort + "/wd/hub");
		else
			serverUrl = new URL("http://" + appium_host + ":" + appiumPort + "/wd/hub");
